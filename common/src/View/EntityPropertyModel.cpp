...
namespace TrenchBroom {
    namespace View {
        ...
        m_keyMutable(true),
        m_valueMutable(true),
        m_protected(PropertyProtection::NotProtected) {}
        ...
        void PropertyRow::merge(const Model::EntityNodeBase* other) {
            ...
            if (m_protected != isPropertyProtected(*other, m_key)) {
        ...
        QVariant EntityPropertyModel::data(const QModelIndex& index, const int role) const {
            ...
            if (role == Qt::CheckStateRole) {
                if (index.column() == 2) {
                    ...
                    } else if (row.isProtected() == PropertyProtection::NotProtected) {
        ...
        QVariant EntityPropertyModel::headerData(const int section, const Qt::Orientation orientation, const int role) const {
            if (role == Qt::DisplayRole) {
                ...
                if (section == 2) {
                    return QVariant("Property is preserved in linked groups");
                }
            }
